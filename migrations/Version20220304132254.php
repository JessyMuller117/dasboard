 ...
 */
final class Version20220304132254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE image_cm ADD message_cm_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE image_cm ADD CONSTRAINT FK_BE967543B75A3697 FOREIGN KEY (message_cm_id) REFERENCES message_cm (id)');
        $this->addSql('CREATE INDEX IDX_BE967543B75A3697 ON image_cm (message_cm_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_BE967543B75A3697 ON image_cm');
        $this->addSql('ALTER TABLE image_cm DROP message_cm_id, CHANGE nom_image nom_image VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
